Pod::Spec.new do |s|
    ...
    s.description  = "Input Top Field with Generic input type, try version 0.1.1 work only with String, Will be more Generic day by day. Next part would be AttributedString in version 1.0"
    s.requires_arc = true
